...
"   -1 FLOAT, --alpha1=FLOAT     Umbral voz -> silencio [default: 8.56]\n"
"   -2 FLOAT, --alpha2=FLOAT     Umbral silencio -> voz [default: 8.48]\n"
...
int elems_to_args(Elements *elements, DocoptArgs *args, bool help,
    ...
    for (i=0; i < elements->n_options; i++) {
        ...
        } else if (!strcmp(option->olong, "--n-init")) {
            if (option->argument)
                args->n_init = option->argument;
...
DocoptArgs docopt(int argc, char *argv[], bool help, const char *version) {
    DocoptArgs args = {
        0, 0, 0, (char*) "8.56", (char*) "8.48", NULL, (char*) "9", (char*) "0",
        (char*) "8", NULL, NULL,
